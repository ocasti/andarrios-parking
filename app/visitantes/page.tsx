...
export default function VisitantesPage() {
  ...
  return (
    <AppShell>
      <div className="ph"><h2>Visitantes</h2><p>Registro de ingreso y salida con cobro automático</p></div>
      ...
      <div className="card">
        <div className="ctit" style={{ marginBottom: '1rem' }}>🛬 Registrar ingreso</div>
        ...
        <button className="btn bp" onClick={submit}>🛬 Registrar ingreso</button>
      </div>
      <div className="card">
            ...
            <table>
              ...
              <tbody>{visitantes.map((v) => {
                ...
                return (<tr key={v.id}>
                  ...
                  <td><button className="btn bs sm" onClick={() => setSalidaId(v.id)}>🛫 Salida</button></td>
                </tr>); })}</tbody>
            </table>
          )}
        </div>
