...
import { checkInVisitor } from '@/src/domain/use-cases/visitantes/CheckInVisitor';
import { checkOutVisitor } from '@/src/domain/use-cases/visitantes/CheckOutVisitor';
import { registerResident } from '@/src/domain/use-cases/residentes/RegisterResident';
import { removeResident } from '@/src/domain/use-cases/residentes/RemoveResident';
import { markAsPaid } from '@/src/domain/use-cases/mensualidades/MarkAsPaid';
import { performDailyClose } from '@/src/domain/use-cases/caja/PerformDailyClose';
import { updatePricing } from '@/src/domain/use-cases/tarifas/UpdatePricing';
...
import type { CheckInVisitorInput, CheckInVisitorOutput } from '@/src/domain/use-cases/visitantes/CheckInVisitor';
import type { CheckOutVisitorInput, CheckOutVisitorOutput } from '@/src/domain/use-cases/visitantes/CheckOutVisitor';
import type { RegisterResidentInput } from '@/src/domain/use-cases/residentes/RegisterResident';
import type { MarkAsPaidInput } from '@/src/domain/use-cases/mensualidades/MarkAsPaid';
import type { PerformDailyCloseInput } from '@/src/domain/use-cases/caja/PerformDailyClose';
